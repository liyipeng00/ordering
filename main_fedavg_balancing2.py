...
from sim.algorithms.fedbase import FedClient, BalancingFedServerII
...
def customize_record_name(args):
    ...
    '''BalancingFedAvgII_M10_P10_K2_R4_mlp_mnist_exdir2,10.0_sgd0.001,1.0,0.0,0.0001_b20_seed1234_clip0.csv'''
    if args.partition in ['exdir', 'exdirb']:
    ...
    record_name = f'BalancingFedAvgII{args.global_lr}_M{args.M},{args.P}_K{args.K}_R{args.R},{args.eval_every}_{args.m}_{args.d}_{partition}'\
...
def main():
    ...
    for round in range(args.start_round, args.R):
        ...
        for c_id in selected_clients:
            ...
            server.update_client_order(local_delta, c_id)
