...
def _weights_init(m):
    ...
    #Note We use the code above same as [1] to init weights. But We found that code in [3] is below.
    # We're not sure whether the code above is out-dated. So We raise the problem here.
    # We realy appreciate it if someone could help us with this.
    # [2022 05 02]
