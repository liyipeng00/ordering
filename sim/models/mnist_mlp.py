'''Multi-Layer Perceptron for MNIST and Fashion-MNIST
This code is mainly from [1]. We make some modifications according to [2], 
i.e., remove `self.softmax = nn.Softmax()` and then use `CrossEntropy()` instead of `NLLLoss()`.
