'''ResNets with Group Normalization
https://github.com/alpemreacar/FedDyn
https://github.com/Divyansh03/FedExP/blob/main/util_models.py

Even though this resnet is common in Federated Learning,
it is different from the original net for CIFAR-10 of "Deep Residual Learning for Image Recognition".
See https://github.com/akamaster/pytorch_resnet_cifar10

So, we call it "resnetgnii" (group normalization, second version).
'''
import torch
...
def resnetgnii10(num_classes=10):
    return ResNet(BasicBlock, [1,1,1,1], num_classes=num_classes)

def resnetgnii18(num_classes=10):
